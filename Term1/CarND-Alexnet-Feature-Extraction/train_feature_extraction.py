...
X_train, X_valid, y_train, y_valid = train_test_split(dataset['features'], dataset['labels'], test_size=0.33, random_state=0)
...
train_op = minimizer.minimize(loss_op, var_list=[fc8W, fc8b])
